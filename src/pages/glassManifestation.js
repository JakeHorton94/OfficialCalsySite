...
const GlassManifestationPage = () => {
  const data = useStaticQuery(graphql`
    query {
        allMarkdownRemark(filter: {frontmatter: {glassManifestation: {eq: true}}, fields: {slug: {}}}) {
          edges {
            node {
              fields {
                slug 
        ...
        return (
            <Layout>
              <Helmet>
      <title>Glass Manifestations</title>
    </Helmet>
                <img className="serviceLogo" src="https://i.imgur.com/WxdCkEP.png" alt="glass manifestations"></img>
...
export default GlassManifestationPage
