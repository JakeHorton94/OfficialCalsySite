...
const SiteHoardingPage = () => {
  const data = useStaticQuery(graphql`
    query {
        allMarkdownRemark(filter: {frontmatter: {siteHoarding: {eq: true}}, fields: {slug: {}}}) {
          edges {
            node {
              fields {
                slug 
        ...
        return (
            <Layout>
              <Helmet>
      <title>Site Hoarding</title>
    </Helmet>
                <img className="serviceLogo" src="https://i.imgur.com/RvPYWVw.png" alt="site hoarding"></img>
...
export default SiteHoardingPage
