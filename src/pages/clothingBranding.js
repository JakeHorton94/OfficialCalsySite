    ...
    query {
      ...
      <title>Clothing Branding</title>
              ...
              <div className="section1">
                ...
                <p className="serviceIntro"> <Link aria-label="Link to contact page" to="/contact"> Contact us now </Link> for a free no obligation quotation </p>
